...
class Adjustment():
    ...
    def set_volume(cls,song_list,offset_list,output_dir):
        ...
        cls.run_in_parallel(set_volume_args)

    @classmethod
    def set_volume_to_mp3(cls,args):
...
if __name__ == "__main__":
    ...
    print(volume_analysis.volume_analysis.find_song_with_max_mean_volume(song_list))
    print("max max volume")
    song_max_volume= volume_analysis.volume_analysis.find_song_with_max_max_volume(song_list)
    print(song_max_volume)
    maximum_volume=song_list[song]["max_volume"]
    offset_list= volume_analysis.volume_analysis.find_volume_offset_based_on_max_max_volume(maximum_volume, song_list)
