...
class Test_Detection_E2E():
    ...
    def test_list_of_files(self):
        ...
        output = detection.volume_detection.detect_volume_from_files(song_list['3_songs'])
    ...
    def test_list_of_folders(self):
        song_list=Test_Detection_E2E.prepare_song_list()
        output = detection.volume_detection.detect_volume_from_files([song_list["test_data_input_folder"]])
