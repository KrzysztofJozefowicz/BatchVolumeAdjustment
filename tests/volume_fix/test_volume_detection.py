...
def test_get_files(monkeypatch,return_list_of_files,input_path,asertion):
...
def test_get_files_with_non_valid_input(monkeypatch,return_list_of_files,input_path):
    def return_list_files_in_dir(path):
        return(return_list_of_files)
